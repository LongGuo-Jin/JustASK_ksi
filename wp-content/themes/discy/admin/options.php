...
function discy_admin_options() {
	$old_version = get_option("discy_old_version");
	// Background Defaults
	...
	$options[] = array(
		'name' => esc_html__('Activate the go up button at the site','discy'),
	...
	$options[] = array(
		'name'      => esc_html__("Choose the groups you need not allow for they to see the wp admin top bar.","discy"),
		'id'        => 'top_bar_groups',
		'type'      => 'multicheck',
	...
	$options[] = array(
		'name'      => esc_html__("Choose the groups you need not allow for they to see the wp admin.","discy"),
		'id'        => 'redirect_groups',
		'type'      => 'multicheck',
		'options'   => $groups_no_admin,
	...
	$options[] = array(
		'name'      => esc_html__('Send mail when the post need a review','discy'),
	...
	$options[] = array(
		'name'    => esc_html__("Select what's show at add post form","discy"),
		'id'      => 'add_post_items',
		'type'    => 'multicheck',
		'sort'    => 'yes',
		'std'     => $add_post_items,
	...
	$options[] = array(
		'name'      => esc_html__('Activate it first from Inner pages setting.','discy'),
	...
	if (class_exists("WPQA")) {
		...
		$options[] = array(
			'name' => esc_html__('Do you need to activate might like options?','discy'),
			'desc' => esc_html__('Select ON if you want to activate might like for the questions and answers.','discy'),
			'id'   => 'might_like',
			'type' => 'checkbox'
		);
		...
		$options[] = array(
			'name'      => esc_html__('Activate user to can choose own answer as the best answer','discy'),
			'desc'      => esc_html__('The user to can choose own answer as the best answer enable or disable.','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Activate the question bump','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Add the points users must add to allow them to can bump the question.','discy'),
		...
		$options[] = array(
			'name' => esc_html__('When delete the question or answer have a best answer remove it from the stats and user points?','discy'),
		...
		*/
		...
		$options[] = array(
			'name' => esc_html__('Activate the reports in site for the logged users only?','discy'),
			'desc' => esc_html__('Activate the reports in site for the logged users only enable or disable.','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Activate the users have such points can move the question or answer to trash or draft by reporting.','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Add the points to allow the users which have them to move the question or answer to trash or draft when report it.','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Activate the pop up at the author image in site?','discy'),
		...
		$options[] = array(
			'name'      => esc_html__('Send mail when the question need a review','discy'),
		...
		$options[] = array(
			'name'    => esc_html__('The schedule mails time','discy'),
		...
		$options[] = array(
			'name'    => esc_html__('Send schedule mails for custom groups to send a list with recent questions','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Send mail for the users to notification a new question','discy'),
		...
		$options[] = array(
			'name'      => esc_html__('Send mail for custom groups to notification a new question','discy'),
		...
		$options[] = array(
			'name'      => esc_html__('Activate suggested questions at the title while user is adding his question','discy'),
		...
		$options[] = array(
			'name'    => esc_html__('Select the checked by default options at add a new question','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Activate the poll for specific groups','discy'),
			'id'   => 'custom_poll_groups',
			'type' => 'checkbox'
		);

		$options[] = array(
			'name'      => esc_html__("Choose the groups to allow them to add poll.","discy"),
			'id'        => 'poll_groups',
		...
		$options[] = array(
			'name' => esc_html__('Add your number of letters for the question title minimum limit, like 15, 20, if you leave it empty will make it not important','discy'),
			'id'   => 'question_title_min_limit',
			'type' => 'text'
		);
		
		$options[] = array(
			'name' => esc_html__('Add your number of letters for the question title limit, like 140, 200, if you leave it empty will make it unlimited','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Add your number of letters for the question tag word minimum limit, like 15, 20, if you leave it empty will make it not important','discy'),
			'id'   => 'question_tags_min_limit',
			'type' => 'text'
		);
		
		$options[] = array(
			'name' => esc_html__('Add your number of letters for the question tag word limit, like 140, 200, if you leave it empty will make it unlimited','discy'),
			'id'   => 'question_tags_limit',
			'type' => 'text'
		);

		$options[] = array(
			'name' => esc_html__('Add your number of items for the question tags minimum limit, like 2, 4, if you leave it empty will make it not important','discy'),
			'id'   => 'question_tags_number_min_limit',
			'type' => 'text'
		);
		
		$options[] = array(
			'name' => esc_html__('Add your number of items for the question tags limit, like 4, 6, if you leave it empty will make it unlimited','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Add your number of letters for the question poll title minimum limit, like 15, 20, if you leave it empty will make it not important','discy'),
			'id'   => 'question_poll_min_limit',
			'type' => 'text'
		);
		
		$options[] = array(
			'name' => esc_html__('Add your number of letters for the question poll title limit, like 140, 200, if you leave it empty will make it unlimited','discy'),
			'id'   => 'question_poll_limit',
			'type' => 'text'
		);

		$options[] = array(
			'name' => esc_html__('Add your number of items for the question poll title minimum limit, like 2, 4, if you leave it empty will make it not important','discy'),
			'id'   => 'question_poll_number_min_limit',
			'type' => 'text'
		);
		
		$options[] = array(
			'name' => esc_html__('Add your number of items for the question poll title limit, like 4, 6, if you leave it empty will make it unlimited','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Add your number of letters for the question content minimum limit, like 15, 20, if you leave it empty will make it not important','discy'),
			'id'   => 'question_content_min_limit',
			'type' => 'text'
		);
		
		$options[] = array(
			'name' => esc_html__('Add your number of letters for the question content limit, like 140, 200, if you leave it empty will make it unlimited','discy'),
		...
		$options[] = array(
			'name' => esc_html__('After edit question change the URL from the title?','discy'),
			'desc' => esc_html__('Press ON to edit the URL','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Activate user can add the questions at favorite','discy'),
		...
		if ($old_version > 3.2) {
			$html_content = '<a href="'.wpqa_add_category_permalink().'" target="_blank">'.esc_html__('The Link For The Add Category Page.','discy').'</a>';
		...
		$options[] = array(
			'name' => esc_html__('Send mail when the category need a review','discy'),
		...
		$options[] = array(
			...
			'desc' => esc_html__("Select ON to upload your default cover for the categories didn't have cover.","discy"),
		...
		$options[] = array(
			'name'      => esc_html__('Select ON to active the read more by jQuery in questions','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Select ON to active to see some answers and add a new answer by jQuery in questions','discy'),
		...
		$options[] = array(
			'name' => esc_html__('Activate the answer at loop by best answer, most voted, last answer or first answer','discy'),
		...
		$options[] = array(
			...
			'desc' => esc_html__('Select ON if you want active the related questions after content.','discy'),
			'id'   => 'question_related',
			'type' => 'checkbox'
		);
		...
		$options[] = array(
			...
			'options' => array(
				...
				'tags'       => esc_html__('Questions in the same tags (If not find any tags will show by the same categories)','discy'),
		...
		$options[] = array(
			'name'    => esc_html__("Choose the groups ask a question without pay.","discy"),
			'id'      => 'payment_group',
			'type'    => 'multicheck',
			'options' => $new_roles
		);
	...
	$options[] = array(
		'name' => esc_html__('Captcha enable or disable (in add new category form)','discy'),
	...
	$options[] = array(
		'name' => sprintf(esc_html__('You can get the reCaptcha site and secret keys from: %s','discy'),'<a href="https://www.google.com/recaptcha/admin/" target="_blank">'.esc_html__('here','discy').'</a>'),
		'type' => 'info'
	);
	...
	$options[] = array(
		...
		'desc' => esc_html__("Select ON to upload your default image for the user didn't upload the image profile.","discy"),
	...
	$options[] = array(
		'name' => esc_html__('Default cover enable or disable.','discy'),
		'desc' => esc_html__("Select ON to upload your default cover for the user didn't upload the cover profile.","discy"),
	...
	$options[] = array(
		'name'    => esc_html__('Choose the groups or users for the custom notification','discy'),
		'desc'    => esc_html__('Choose from here which groups or users you want to send the custom notification.','discy'),
		'id'      => 'notification_groups_users',
		'options' => array(
			'groups' => esc_html__('Groups','discy'),
	...
	$options[] = array(
		'name'      => esc_html__("Choose the groups you need to send the custom notification for them.","discy"),
	...
	$options[] = array(
		'name' => esc_html__('You must save your options before send the notification.','discy'),
		'type' => 'info'
	);

	$html_content = '<a href="#" class="button button-primary send-custom-notification">'.esc_html__('Send the custom notification','discy').'</a>';
	...
	$options[] = array(
		'name'    => esc_html__('Add the black list emails or any domain to stop them from register','discy'),
		'id'      => "black_list_emails",
		'type'    => "elements",
		'sort'    => "no",
		'hide'    => "yes",
		'button'  => esc_html__('Add new email','discy'),
		'options' => array(
			array(
				"type" => "text",
				"id"   => "email",
	...
	$options[] = array(
		'name' => esc_html__('Send mail when user registered as a welcome mail','discy'),
	...
	$options[] = array(
		...
		'desc' => esc_html__('Select ON to review the users before complete the register.','discy'),
		'id'   => 'user_review',
		'type' => 'checkbox'
	);
	
	$options[] = array(
		'name'      => esc_html__('Send mail when user need a review','discy'),
	...
	$options[] = array(
		'name' => esc_html__('Confirm the email enable or disable','discy'),
		'id'   => 'confirm_email',
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'name' => esc_html__('Activate the page Terms of Service and privacy policy?','discy'),
		'desc' => esc_html__('Select ON if you want active the page Terms of Service and privacy policy.','discy'),
	...
	$options[] = array(
		...
		'options' => array(
			...
			"received_email"          => esc_html__('Send mail when user add a new question','discy'),
			...
			"unsubscribe_mails"       => esc_html__("Unsubscribe all the mail","discy"),
		)
	);
	...
	$options[] = array(
		'name'    => esc_html__('Forgot password popup style','discy'),
		'desc'    => esc_html__('Choose forgot password popup style from here.','discy'),
		'id'      => 'pass_style',
		'options' => array(
			'style_1' => esc_html__('Style 1','discy'),
			'style_2' => esc_html__('Style 2','discy'),
	...
	$options[] = array(
		'name'    => esc_html__('Logo for the forgot password popup','discy'),
		'id'      => 'logo_pass',
		'type'    => 'upload',
	...
	$options[] = array(
		'name' => esc_html__('Logo retina for the forgot password popup','discy'),
		'id'   => 'logo_pass_retina',
		'type' => 'upload'
	);
	...
	$options[] = array(
		'name' => esc_html__('Text for the forgot password popup after the logo or the normal text','discy'),
		'id'   => 'text_pass',
		'type' => 'text'
	);
	...
	$options[] = array(
		...
		"name" => esc_html__('Details for forgot password popup','discy')
	);
	...
	$edit_profile_sections = array(
		...
		array('name' => esc_html__('Custom Left Menu With Categories','discy'),"value" => "categories","default" => "yes"),
		array('name' => esc_html__('Mails setting','discy'),"value" => "mails_setting","default" => "yes"),
		array('name' => esc_html__('Delete account','discy'),"value" => "delete_account","default" => "yes"),
	);
	...
	$edit_profile_items_4 = array(
		...
		"send_emails"             => array("sort" => esc_html__('Send mail when any user ask question','discy'),"value" => "send_emails"),
		...
		"unsubscribe_mails"       => array("sort" => esc_html__('Unsubscribe all the mail','discy'),"value" => "unsubscribe_mails"),
	);
	
	$options[] = array(
		'name'    => esc_html__("Select what's show at edit profile at the mails section","discy"),
	...
	$options[] = array(
		'name' => esc_html__('Do you need to allow for the users to add a custom categories at the left menu?','discy'),
	...
	$options[] = array(
		'name' => esc_html__('Do you need to allow for the users to delete their account?','discy'),
		'id'   => 'delete_account',
		'std'  => 'on',
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		...
		'type' => 'text',
		'std'  => 'Spread the world. Earn points.'
	);
	...
	$options[] = array(
		...
		'type' => 'textarea',
		'std'  => 'We have a number of ways to help spread the world to your friends and family, Choose whatever works best for you.'
	);
	...
	$options[] = array(
		'name'    => esc_html__('Show the popup notification for the user one time only or for ever','discy'),
		'id'      => 'popup_notification_time',
		'options' => array(
			'one_time' => esc_html__('One time','discy'),
			'for_ever' => esc_html__('For ever','discy'),
		),
		'std'     => 'one_time',
		'type'    => 'radio'
	);
	...
	$options[] = array(
		'name'    => esc_html__('Choose the groups or users for the popup notification','discy'),
		'desc'    => esc_html__('Choose from here which groups or users you want to send the popup notification.','discy'),
	...
	$options[] = array(
		'name'      => esc_html__("Choose the groups you need to send the popup notification for them.","discy"),
	...
	$options[] = array(
		'name' => esc_html__('You must save your options before send the popup notification.','discy'),
		'type' => 'info'
	);

	$html_content = '<a href="#" class="button button-primary send-popup-notification">'.esc_html__('Send the popup notification','discy').'</a>';
	...
	$options[] = array(
		'name' => esc_html__('Select ON to can ask a question.','discy'),
		'id'   => 'ask_question',
		'std'  => "on",
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'name' => esc_html__('Select ON to can add a category.','discy'),
		'id'   => 'add_category',
		'std'  => "on",
		'type' => 'checkbox'
	);
	...
	$options[] = array(
		'name' => esc_html__('Select ON to approve the questions auto when have media attached.','discy'),
	...
	$options[] = array(
		'name' => esc_html__('Select ON to approve the answers auto when have media attached.','discy'),
	...
	$options[] = array(
		'name' => esc_html__('Send mail after sent a message?','discy'),
	...
	$options[] = array(
		'name' => esc_html__('Activate user can seen the message by send notification','discy'),
	...
	$groups_user_only = $new_roles;
	unset($groups_user_only["wpqa_under_review"]);
	unset($groups_user_only["ban_group"]);
	unset($groups_user_only["activation"]);

	$options[] = array(
		'name'    => esc_html__('Choose the groups or users for the custom message','discy'),
		'desc'    => esc_html__('Choose from here which groups or users you want to send the custom message.','discy'),
	...
	$options[] = array(
		'name'      => esc_html__("Choose the groups you need to send the custom message for them.","discy"),
	...
	$html_content = '<a href="#" class="button button-primary send-custom-message">'.esc_html__('Send the custom message','discy').'</a>';
	...
	unset($badges_groups["wpqa_under_review"]);
	unset($badges_groups["ban_group"]);
	...
	$options[] = array(
		'name' => esc_html__('Add your number of letters for the comment minimum limit, like 15, 20, if you leave it empty will make it not important','discy'),
	...
	$options[] = array(
		...
		'std'  => '&copy; 2020 Discy. All Rights Reserved<br>With Love by <a href="https://2code.info/" target="_blank">2code</a>.',
		'type' => 'textarea'
	);
	...
	$options[] = array(
		'type'    => 'content',
		'content' => '<h4>Variables work for the custom template</h4>
	...
	$options[] = array(
		'name'    => esc_html__('Choose the groups or users for the custom mail','discy'),
		'desc'    => esc_html__('Choose from here which groups or users you want to send the custom mail.','discy'),
	...
	$options[] = array(
		'name'      => esc_html__("Choose the groups you need to send the custom mail for them.","discy"),
	...
	$html_content = '<a href="#" class="button button-primary send-custom-mail">'.esc_html__('Send the custom mail','discy').'</a>';
	...
	$options[] = array(
		'name'      => esc_html__('Note: if you need this mail template, From Discy Settings >> Payment setting >> Activate one of the payments functions.','discy'),
		'condition' => 'buy_points_payment:is(0),pay_ask:is(0),pay_to_sticky:is(0)',
		'type'      => 'info'
	);
	...
	$options[] = array(
		'type'      => 'heading-2',
		'operator'  => 'or',
		'condition' => 'buy_points_payment:not(0),pay_ask:not(0),pay_to_sticky:not(0)',
		'div'       => 'div'
	);
	...
	$options[] = array(
		'name' => esc_html__('Posts mails','discy'),
		'id'   => 'posts_mails',
		'type' => 'heading-2'
	);
	...
	$options[] = array(
		'type'    => 'content',
		'content' => '<h4>Variables work at Send message template and New questions template to show the details for the recieved user</h4>
		<p>[%user_login%] - The user login name.</p>
		<p>[%user_name%] - The user name.</p>
		<p>[%user_nicename%] - The user nice name.</p>
		<p>[%display_name%] - The user display name.</p>
	...
	$options[] = array(
		...
		'std'      => "<p>Hi there</p><p>There are a new questions</p>",
		'type'     => 'editor',
		'settings' => $wp_editor_settings
	);
	...
	$options[] = array(
		'name'      => esc_html__('Note: if you need this mail template, From Discy Settings >> Questions settings >> Questions categories setting >> Activate the users to request a new category && Send mail when the category need a review.','discy'),
		'operator'  => 'or',
	...
	$options[] = array(
		'id'   => 'uniqid_cookie',
		'std'  => (class_exists("WPQA") && $old_version > 3.4?wpqa_token(15):rand(1,100000)),
		'type' => 'hidden'
	);
