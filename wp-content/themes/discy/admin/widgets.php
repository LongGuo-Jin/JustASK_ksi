...
function discy_admin_widgets() {
	...
	$options['users-widget'] = array(
		...
		array(
			'name' => esc_html__('This option will work only if you activated, Questions settings/Questions categories setting/Activate the points by category.','discy'),
			'type' => 'info',
		),
		array(
		...
		array(
			'name' => esc_html__('This option will work only if you activated, Questions settings/General settings/Activate the points sort with specific days.','discy'),
			'type' => 'info',
		),
		array(
