	...
	jQuery(window).load(function() {
		...
		jQuery("#discy_builder_meta_tab,#discy_slideshow_post").on("click",".add-item",function () {
			...
			if (builder_item == "add_slide") {
				...
				jQuery('#discy_slideshow_post ul').append('<li id="builder_slide_'+builder_slide_j+'" data-id="builder_slide_item['+builder_slide_j+']"><div><a class="widget-handle ui-sortable-handle"><span class="dashicons dashicons-editor-justify"></span></a><a class="del-builder-item del-sidebar-item"><span class="dashicons dashicons-trash"></span></a><div title="Clone" class="builder_clone"><span class="dashicons dashicons-welcome-add-page"></span></div></div><div class="widget-content"><h4 class="heading">'+discy_js.image_url+'</h4><div class="rwmb-input"><input id="builder_slide_item['+builder_slide_j+'][image_url]" name="builder_slide_item['+builder_slide_j+'][image_url]" type="text" class="upload upload_image_'+builder_slide_j+'"><input class="upload_image_button button upload-button-2" rel="'+builder_slide_j+'" type="button" value="Upload"><input type="hidden" class="image_id" name="builder_slide_item['+builder_slide_j+'][image_id]"></div><div class="clear"></div><h4 class="heading">Slide Link</h4><div class="rwmb-input"><input id="builder_slide_item['+builder_slide_j+'][slide_link]" name="builder_slide_item['+builder_slide_j+'][slide_link]" value="#" type="text"></div><div class="clear"></div></div></li>');
		...
		jQuery(".discy_framework #role_add").click(function() {
			...
			if (role_name != "" ) {
				if( role_name.length){
					...
					jQuery('#roles_list').append('<li id="li_roles_'+roles_j+'"><div class="widget-head">'+role_name+'<a class="del-roles-item del-builder-item del-sidebar-item"><span class="dashicons dashicons-trash"></span></a></div><div class="widget-content"><div class="widget-content-div"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][new]" type="hidden" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][new]" value="new"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][group]" type="hidden" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][group]" value="'+role_name+'"><input type="hidden" class="group_role_name" name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][id]" value="group_'+ roles_j +'"><div class="clearfix"></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][ask_question]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][ask_question]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][ask_question]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][ask_question]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][ask_question]">'+discy_js.ask_question+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_question]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_question]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_question]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_question]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_question]">'+discy_js.show_question+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_answer]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_answer]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_answer]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_answer]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_answer]">'+discy_js.add_answer+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_answer]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_answer]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_answer]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_answer]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][show_answer]">'+discy_js.show_answer+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_post]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_post]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_post]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_post]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_post]">'+discy_js.add_post+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_category]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_category]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_category]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_category]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][add_category]">'+discy_js.add_category+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][send_message]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][send_message]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][send_message]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][send_message]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][send_message]">'+discy_js.send_message+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][upload_files]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][upload_files]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][upload_files]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][upload_files]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][upload_files]">'+discy_js.upload_files+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_question]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_question]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_question]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_question]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_question]">'+discy_js.approve_question+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_answer]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_answer]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_answer]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_answer]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_answer]">'+discy_js.approve_answer+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_post]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_post]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_post]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_post]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_post]">'+discy_js.approve_post+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_comment]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_comment]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_comment]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_comment]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_comment]">'+discy_js.approve_comment+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_question_media]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_question_media]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_question_media]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_question_media]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_question_media]">'+discy_js.approve_question_media+'</label></div></div></div><div class="section section-checkbox"><div class="option"><div class="controls"><label class="switch" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_answer_media]"><input id="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_answer_media]" value="on" class="checkbox discy-input" type="checkbox" checked name="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_answer_media]"><label for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_answer_media]" data-on="'+discy_js.on+'" data-off="'+discy_js.off+'"></label></label><label class="explain explain-checkbox" for="'+discy_js.discy_theme+'['+data_id+'][group_'+ roles_j +'][approve_answer_media]">'+discy_js.approve_answer_media+'</label></div></div></div></div></div></li>');
	...
	if (jQuery('.send-custom-mail').length) {
	    jQuery(".send-custom-mail").click(function() {
			...
			jQuery.ajax({
				url: discy_js.ajax_a,
				type: "POST",
				data: { action : 'discy_send_custom_mail' },
				success:function(data) {
					setTimeout(function() {
	...
	if (jQuery('.send-custom-notification').length) {
	    jQuery(".send-custom-notification").click(function() {
			...
			jQuery.ajax({
				url: discy_js.ajax_a,
				type: "POST",
				data: { action : 'discy_send_custom_notification' },
				success:function(data) {
					setTimeout(function() {
	    				jQuery("#loading").fadeOut("slow");
	...
	if (jQuery('.send-custom-message').length) {
	    jQuery(".send-custom-message").click(function() {
			...
			jQuery.ajax({
				url: discy_js.ajax_a,
				type: "POST",
				data: { action : 'discy_send_custom_message' },
				success:function(data) {
					setTimeout(function() {
	    				jQuery("#loading").fadeOut("slow");
	...
	if (jQuery('.send-popup-notification').length) {
	    jQuery(".send-popup-notification").click(function() {
			...
			jQuery.ajax({
				url: discy_js.ajax_a,
				type: "POST",
				data: { action : 'discy_send_popup_notification',post_id : post_id },
				success:function(data) {
					setTimeout(function() {
	    				jQuery("#loading").fadeOut("slow");
