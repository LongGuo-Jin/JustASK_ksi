...
function discy_admin_meta() {
	...
	if (discy_is_post_type(array("page"))) {
		...
		$home_tabs = array(
			...
			"answers-might-like"   => array("sort" => esc_html__('Answers Might Like','discy'),"value" => ""),
			...
			"answers-might-like-2" => array("sort" => esc_html__('Answers Might Like With Time','discy'),"value" => ""),
		...
		$options[] = array(
			'name'      => esc_html__('Specific date for answers might like tab.','discy'),
			'desc'      => esc_html__('Select the specific date for answers might like tab.','discy'),
		...
		$options[] = array(
			'name'      => esc_html__('Answers might like slug','discy'),
		...
		$options[] = array(
			'name'      => esc_html__('Answers might like with time slug','discy'),
	...
	if (discy_is_post_type(array("post","page","question"))) {
		...
		if (discy_is_post_type(array("page"))) {
			$options[] = array(
				'name' => esc_html__('Activate this page for unlogged users, uncomfirmed users and unreviewed users?','discy'),
				'desc' => esc_html__('Select ON to active this page for unlogged users, uncomfirmed users and unreviewed users','discy'),
			...
			$options[] = array(
				...
				'desc' => esc_html__('Select ON to active this page for banned users','discy'),
	...
	if (discy_is_post_type(array("post","page","question"))) {
		...
		if (discy_is_post_type(array("question"))) {
			...
			$options[] = array(
				...
				'desc' => esc_html__('Type related questions number from here','discy'),
				'id'   => prefix_meta.'related_number',
				'std'  => 5,
				'type' => 'text'
			);
			...
			$options[] = array(
				'name'    => esc_html__('Query type','discy'),
				'desc'    => esc_html__('Select what the related questions will show.','discy'),
				'id'      => prefix_meta.'query_related',
				'std'     => 'categories',
				'options' => array(
...
function discy_options_question_feed($options,$home = '') {
	...
	$options[] = array(
		'name' => esc_html__('Number of users to allow for the user make his feed','discy'),
	...
	$options[] = array(
		'name'  => esc_html__('Show load more the users?','discy'),
	...
	$options[] = array(
		'name' => esc_html__('Number of categories to allow for the user make his feed','discy'),
	...
	$options[] = array(
		'name'  => esc_html__('Show load more the categories?','discy'),
	...
	$options[] = array(
		'name' => esc_html__('Number of tags to allow for the user make his feed','discy'),
	...
	$options[] = array(
		'name'  => esc_html__('Show load more the tags?','discy'),
