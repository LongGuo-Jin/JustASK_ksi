...
if ($wp_page_template == "template-home.php") {
	$home_feed = discy_post_meta("home_feed");
	$user_sort = discy_post_meta("user_sort_home_feed");
	$user_style = discy_post_meta("user_style_home_feed");
	$masonry_style = discy_post_meta("masonry_user_style_home_feed");
	$users_per = discy_post_meta("users_per_home_feed");
	$cat_sort = discy_post_meta("cat_sort_home_feed");
	$cat_style = discy_post_meta("cat_style_home_feed");
	$cat_per = discy_post_meta("cat_per_home_feed");
	$tag_sort = discy_post_meta("tag_sort_home_feed");
	$tag_per = discy_post_meta("tag_per_home_feed");
	$number_of_users = discy_post_meta("users_home_feed");
	$number_of_categories = discy_post_meta("categories_home_feed");
	$number_of_tags = discy_post_meta("tags_home_feed");
	$users_slider = discy_post_meta("users_slider_home_feed");
	$cats_slider = discy_post_meta("cats_slider_home_feed");
	$tags_slider = discy_post_meta("tags_slider_home_feed");
	$users_more = discy_post_meta("users_more_home_feed");
	$cats_more = discy_post_meta("cats_more_home_feed");
	$tags_more = discy_post_meta("tags_more_home_feed");
}else {
	$home_feed = discy_post_meta("feed");
	$user_sort = discy_post_meta("user_sort_feed");
	$user_style = discy_post_meta("user_style_feed");
	$masonry_style = discy_post_meta("masonry_user_style_feed");
	$users_per = discy_post_meta("users_per_feed");
	$cat_sort = discy_post_meta("cat_sort_feed");
	$cat_style = discy_post_meta("cat_style_feed");
	$cat_per = discy_post_meta("cat_per_feed");
	$tag_sort = discy_post_meta("tag_sort_feed");
	$tag_per = discy_post_meta("tag_per_feed");
	$number_of_users = discy_post_meta("users_feed");
	$number_of_categories = discy_post_meta("categories_feed");
	$number_of_tags = discy_post_meta("tags_feed");
	$users_slider = discy_post_meta("users_slider_feed");
	$cats_slider = discy_post_meta("cats_slider_feed");
	$tags_slider = discy_post_meta("tags_slider_feed");
	$users_more = discy_post_meta("users_more_feed");
	$cats_more = discy_post_meta("cats_more_feed");
	$tags_more = discy_post_meta("tags_more_feed");
}
