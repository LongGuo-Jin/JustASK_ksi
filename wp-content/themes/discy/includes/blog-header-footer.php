...
if ($blog_h == "on") {
	...
	if (((is_front_page() || is_home()) && $blog_h_home_pages == "home_page") || $blog_h_home_pages == "all_pages" || ($blog_h_home_pages == "custom_pages" && is_page() && is_array($blog_h_pages) && isset($post->ID) && in_array($post->ID,$blog_h_pages))) {?>
