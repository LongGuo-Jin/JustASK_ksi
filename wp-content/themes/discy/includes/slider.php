														...
														<?php }else if ($block == "question") {?>
															<div class="slider-form slider-ask-form">
																<form>
																	...
																	<a href="<?php echo (class_exists("WPQA")?wpqa_add_question_permalink():"#")?>" class="ask-click wpqa-question<?php echo apply_filters('wpqa_pop_up_class','').apply_filters('wpqa_pop_up_class_question','')?>"></a>
