		...
		<div class="call-action-unlogged call-action-<?php echo esc_attr($action_skin).' call-action-'.esc_attr($action_style)?>">
			<?php if ($action_image_video == "video") {
				if ($video_type == "html5") {
					...
					echo '<div class="call-action-video"><iframe frameborder="0" allow="autoplay" height="100%" width="100%" src="'.$type.'?autoplay=1"></iframe></div>';
				}
			}
			...
			<div class="discy-container">
				<div class="<?php echo ($action_style == "style_1"?"col6":"col12")?>">
					...
					<?php }
					if ($action_paragraph != "") {?>
						<p><?php echo discy_kses_stip(nl2br($action_paragraph))?></p>
					<?php }
