...
var $window=jQuery(window);var is_RTL=jQuery('body').hasClass('rtl')?true:false;jQuery("nav.nav ul li ul").parent("li").addClass("parent-list");jQuery(".parent-list").find("a:first").append(" <span class='menu-nav-arrow'><i class='icon-right-open-mini'></i></span>");jQuery("nav.nav ul a").removeAttr("title");jQuery("nav.nav ul ul").css({display:"none"});jQuery("nav.nav ul li").each(function(){var sub_menu=jQuery(this).find("ul:first");jQuery(this).hover(function(){sub_menu.stop().css({overflow:"hidden",height:"auto",display:"none",paddingTop:0}).slideDown(200,function(){jQuery(this).css({overflow:"visible",height:"auto"});});},function(){sub_menu.stop().slideUp(50,function(){jQuery(this).css({overflow:"hidden",display:"none"});});});});var fixed_enabled=jQuery("#wrap").hasClass("fixed-enabled");if(fixed_enabled&&jQuery(".header").length){var hidden_header=jQuery(".hidden-header").offset().top;if(hidden_header<40){var aboveHeight=-20;}else{var aboveHeight=hidden_header;}
$window.scroll(function(){if($window.scrollTop()>aboveHeight&&$window.scrollTop()>0){jQuery(".header").css({"top":"0"}).addClass("fixed-nav");}else{jQuery(".header").css({"top":"auto"}).removeClass("fixed-nav");}});}else{jQuery(".header").removeClass("fixed-nav");}
jQuery("nav.nav > ul > li").clone().appendTo('.navigation_mobile > ul');if(jQuery(".call-action-style_1").length){var action_button=jQuery(".call-action-button").outerHeight();var action_content=jQuery(".call-action-style_1 .discy-container").outerHeight();jQuery(".call-action-button").css({"margin-top":(action_content-action_button)/2});}
if(jQuery(".user-click").length){jQuery(".user-click:not(.user-click-not)").on("click",function(){jQuery(".user-notifications.user-notifications-seen").removeClass("user-notifications-seen").find(" > div").slideUp(200);jQuery(".user-messages > div").slideUp(200);jQuery(this).parent().toggleClass("user-click-open").find(" > ul").slideToggle(200);});}
jQuery(".tooltip-n").tipsy({fade:true,gravity:"s"});jQuery(".tooltip-s").tipsy({fade:true,gravity:"n"});jQuery(".tooltip-nw").tipsy({fade:true,gravity:"nw"});jQuery(".tooltip-ne").tipsy({fade:true,gravity:"ne"});jQuery(".tooltip-w").tipsy({fade:true,gravity:"w"});jQuery(".tooltip-e").tipsy({fade:true,gravity:"e"});jQuery(".tooltip-sw").tipsy({fade:true,gravity:"sw"});jQuery(".tooltip-se").tipsy({fade:true,gravity:"se"});if(jQuery(".user-login-click").length){var user_image=jQuery(".user-login-click .user-image");var user_image_h=user_image.outerHeight();var user_login=jQuery(".user-login-click .user-login");var user_login_h=user_login.outerHeight();user_login.css({"margin-top":(user_image_h-user_login_h)/2});$window.bind("resize",function(){var user_image=jQuery(".user-login-click .user-image");var user_image_h=user_image.outerHeight();var user_login=jQuery(".user-login-click .user-login");var user_login_h=user_login.outerHeight();user_login.css({"margin-top":(user_image_h-user_login_h)/2});});}
if(jQuery("nav.nav_menu").length){jQuery(".nav_menu > ul > li > a,.nav_menu > div > ul > li > a").on("click",function(){var li_menu=jQuery(this).parent();if(li_menu.find(" > ul").length){if(li_menu.hasClass("nav_menu_open")){li_menu.find(" > ul").slideUp(200,function(){li_menu.removeClass("nav_menu_open");});}else{li_menu.find(" > ul").slideDown(200,function(){li_menu.addClass("nav_menu_open");});}
jQuery(".discy-main-wrap,.discy-main-inner,.fixed-sidebar,.fixed_nav_menu").css({"height":"auto"});return false;}});}
if(jQuery('.mobile-menu-click').length){jQuery('.mobile-menu-click').each(function(){var mobile_menu_click=jQuery(this);var mobile_aside=jQuery('.'+mobile_menu_click.data("menu"));mobile_aside.find('li.menu-item-has-children').append('<span class="mobile-arrows"><i class="icon-down-open"></i></span>');mobile_aside.find('.mobile-aside-close').on('touchstart click',function(){mobile_aside.removeClass('mobile-aside-open');return false;});jQuery(mobile_menu_click).on('touchstart click',function(){jQuery(".user-notifications.user-notifications-seen").removeClass("user-notifications-seen").find(" > div").slideUp(200);jQuery(".user-messages > div").slideUp(200);var mobile_open=jQuery(this).data("menu");if(jQuery('.'+mobile_open+'.mobile-menu-wrap').hasClass("mobile-aside-open")){jQuery('.mobile-menu-wrap.'+mobile_open).removeClass('mobile-aside-open');}else{jQuery('.'+mobile_open+'.mobile-menu-wrap').addClass('mobile-aside-open');}
jQuery('.mobile-menu-wrap:not(".'+mobile_open+'")').removeClass('mobile-aside-open');return false;});if(mobile_aside.find('ul.menu > li').length){mobile_aside.find('li.menu-item-has-children > a,li.menu-item-has-children > .mobile-arrows').on("touchstart click",function(){jQuery(this).parent().find('ul:first').slideToggle(200);jQuery(this).parent().find('> .mobile-arrows').toggleClass('mobile-arrows-open');return false;});}
...
if(jQuery(".accordion").length){jQuery(".accordion .accordion-title").each(function(){jQuery(this).on("click",function(){if(jQuery(this).parent().parent().hasClass("toggle-accordion")){jQuery(this).parent().find("li:first .accordion-title").addClass("active");jQuery(this).parent().find("li:first .accordion-title").next(".accordion-inner").addClass("active");jQuery(this).toggleClass("active");jQuery(this).next(".accordion-inner").slideToggle(200).toggleClass("active");jQuery(this).find("i").toggleClass("icon-minus").toggleClass("icon-plus");}else{if(jQuery(this).next().is(":hidden")){jQuery(this).parent().parent().find(".accordion-title").removeClass("active").next().slideUp(200);jQuery(this).parent().parent().find(".accordion-title").next().removeClass("active").slideUp(200);jQuery(this).toggleClass("active").next().slideDown(200);jQuery(this).next(".accordion-inner").toggleClass("active");jQuery(this).parent().parent().find("i").removeClass("icon-plus").addClass("icon-minus");jQuery(this).find("i").removeClass("icon-minus").addClass("icon-plus");}}
jQuery(".discy-main-wrap,.discy-main-inner,.fixed-sidebar,.fixed_nav_menu").css({"height":"auto"});return false;});});}
...
$window.load(function(){jQuery(".loader").fadeOut(500);if(jQuery(".user-section-grid,.user-section-simple").length){if(jQuery(".users-masonry").length){jQuery(".users-masonry").isotope({filter:"*",animationOptions:{duration:750,itemSelector:'.user-masonry',easing:"linear",queue:false,}});}else{jQuery('.user-section-grid,.user-section-simple').each(function(){jQuery(this).find('> div > div').matchHeight();});}}
if(jQuery(".user-section-columns").length){if(jQuery(".users-masonry").length){jQuery(".users-masonry").isotope({filter:"*",animationOptions:{duration:750,itemSelector:'.user-masonry',easing:"linear",queue:false,}});}else{jQuery('.user-section-columns').each(function(){jQuery(this).find('.post-inner').matchHeight();});}}
...
if(jQuery(".article-question.post-with-columns").length){if(jQuery(".article-question.post-with-columns.question-masonry").length){jQuery(".question-articles").imagesLoaded(function(){jQuery(".question-articles").isotope({filter:"*",animationOptions:{duration:750,itemSelector:'.question-masonry',easing:"linear",queue:false,}});});}else{jQuery(".article-question.post-with-columns").matchHeight();jQuery(".article-question.post-with-columns > .single-inner-content").matchHeight();}}
...
if($window.width()>991&&jQuery(".page-content.commentslist > ol > .comment").length>3&&jQuery(".page-content.commentslist > ol > .comment .author-image-pop-2").length){var last_answer_h=jQuery(".page-content.commentslist > ol > .comment:last-child").height();var last_popup_h=jQuery(".page-content.commentslist > ol > .comment:last-child .author-image-pop-2").height();if(last_answer_h<last_popup_h){jQuery(".page-content.commentslist > ol > .comment:last-child .author-image-pop-2").addClass("author-image-pop-top");}}});})(jQuery);jQuery.noConflict()(function discy_sidebar(){var main_wrap_h=jQuery(".discy-main-wrap").outerHeight();var main_sidebar_h=jQuery(".inner-sidebar").outerHeight();if(jQuery(".nav_menu_sidebar").length){var nav_menu_h=jQuery(".nav_menu_sidebar").outerHeight();jQuery('.discy-main-wrap,.nav_menu_sidebar').matchHeight();}else{var nav_menu_h=jQuery(".nav_menu").outerHeight();}
if(jQuery('.menu_left').length&&nav_menu_h>main_wrap_h){$window.load(function(){setTimeout(function(){jQuery('.discy-main-inner,nav.nav_menu,div.nav_menu_sidebar').matchHeight();},2000);});}else if((main_wrap_h>nav_menu_h&&jQuery(".fixed_nav_menu").length)||(main_wrap_h>main_sidebar_h&&jQuery(".fixed-sidebar").length)){if(jQuery(".fixed_nav_menu").length){jQuery('.discy-main-wrap,.fixed_nav_menu').theiaStickySidebar({updateSidebarHeight:(jQuery(".widget-footer").length?false:true),additionalMarginTop:(jQuery("#wrap.fixed-enabled").length?jQuery(".hidden-header").outerHeight():0)+jQuery(".admin-bar #wpadminbar").outerHeight()+30});}
if(jQuery(".fixed-sidebar").length){jQuery('.discy-main-wrap,.fixed-sidebar').theiaStickySidebar({updateSidebarHeight:(jQuery(".widget-footer").length?false:true),additionalMarginTop:(jQuery("#wrap.fixed-enabled").length?jQuery(".hidden-header").outerHeight():0)+jQuery(".admin-bar #wpadminbar").outerHeight()});}}});